...
public class StatisticsLifeCycleManager : MonoBehaviour, IStatisticsLifeCycleManager
{
    private List<IStatisticsPresenter> _activePresenters;

    private void Awake()
    {
        _activePresenters = new List<IStatisticsPresenter>();
    }
    ...
    public void UnregisterPresenter(IStatisticsPresenter presenter)
    {
